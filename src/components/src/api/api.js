...
export const authAPI = {
    me(){
        return axios.get(`${baseURL}/2.3/me?order=desc&sort=reputation&site=stackoverflow`)
    }
}

export const searchAPI = {
    search(word){
        return axios.get(`${baseURL}/2.3/search?order=desc&sort=activity&tagged=${word}&site=stackoverflow`)
    }
}